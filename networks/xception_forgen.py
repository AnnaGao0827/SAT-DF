...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=2, num_type=3, num_mag=1, inc=6):
        """ Constructor
        Args:
...
def xception(num_type=3, num_mag=1, pretrained='imagenet', inc=6):
    model = Xception(num_type=num_type, num_mag=num_mag, inc=inc)
    pretrained = False
    if pretrained:
        num_classes = 2
    ...
    weight_norm=False, return_fea=False, inc=6):
        ...
        if modelchoice == 'xception':
            ...
            def return_pytorch04_xception(pretrained=True):
                ...
                model = xception(num_type=num_type, num_mag=num_mag, inc=inc, pretrained=False)
                if pretrained:
